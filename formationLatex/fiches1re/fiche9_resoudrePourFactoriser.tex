...
\newcommand{\path}{../}
\usepackage[fiche,niveau={1MA1},nfiche={9}, annee={Emilie-Gourd, 2025--2026}, auteur={ns},theme={Lien entre les racines d'un polynome et sa forme factorisée}]{\path packages/bandeaux}
...
\begin{boiteExT}[Racines et coefficient dominant]
