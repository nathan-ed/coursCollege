...
\newcommand{\path}{../}
\usepackage[fiche,niveau={1MA1},nfiche={4}, annee={Emilie-Gourd, 2024--2025}, auteur={ns},theme={Équations -- Premier degré à une inconune avec un paramètre}]{\path packages/bandeaux}
