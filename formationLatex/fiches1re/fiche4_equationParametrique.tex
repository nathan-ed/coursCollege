...
\newcommand{\path}{../}
\usepackage[fiche,niveau={1MA1},nfiche={4}, annee={Emilie-Gourd, 2025--2026}, auteur={ns},theme={Équations -- Premier degré à une inconune avec un paramètre}]{\path packages/bandeaux}
