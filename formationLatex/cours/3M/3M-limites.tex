...
Ainsi, il semblerait que la limite de $f(x)$ quand $x$ tend vers 0 depuis la droite vaut $\ldots$
...
Ainsi, il semblerait que la limite de $f(x)$ quand $x$ tend vers 1 vaut $\ldots$
...
\begin{itemize}
\item $x$ tend vers 4 depuis la gauche vaut $\ldots$
\item $x$ tend vers 4 depuis la droite vaut $\ldots$
\end{itemize}
\end{itemize}
\end{tasks}
\end{exemple}
...
\tcblower
Le principe consiste en principe à se ramener à l'utilisation de $\displaystyle\lim_{* \to 0} \dfrac{\sin(*)}{*} = 1$
\end{methode}
...
$= \displaystyle\lim_{-20x \to 0} \dfrac{-20\sin(-20x)}{-20x}$ on fait apparaître cette expression apparaisse au dénominateur et comme (...)$\to$0

$= -20 \displaystyle\lim_{-20x \to 0} \dfrac{\sin(-20x)}{-20x}$ on utilise une propriété des limites

$= -20 \cdot 1$ on utilise $\displaystyle\lim_{* \to 0} \dfrac{\sin(*)}{*} = 1$
...
$= \dfrac{1}{3} \displaystyle\lim_{x \to 0} \dfrac{\sin(x)}{x} \displaystyle\lim_{x \to 0} \dfrac{\sin(x)}{x} \displaystyle\lim_{x \to 0} \dfrac{1}{1+\cos(x)}$ on utilise les propriétés des limites [ok si les nouvelles limites existent]

$= \dfrac{1}{3} \cdot 1 \cdot 1 \cdot \dfrac{1}{1+\cos(0)}$ on utilise $\displaystyle\lim_{* \to 0} \dfrac{\sin(*)}{*} = 1$ et on calcule la 3e limite facilement
