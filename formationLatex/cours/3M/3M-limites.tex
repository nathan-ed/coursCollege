...
\begin{remarque}
	\tcblower
Si l'hypothèse de continuité n'est pas vérifiée, le théorème n'est plus vrai !
\end{remarque}
...
Dans la section \ref{sec:continuite}, nous reviendrons sur cette remarque qui nous permettra d’appréhender une notion très importante, {\bfseries la continuité}.
\end{remarque}
