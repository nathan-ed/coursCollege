...
\begin{remarque}
\tcblower	
Plus généralement, tout « pic » dans la courbe représentative d'une fonction indique un point de non dérivabilité.
\end{remarque}
\begin{exemple}
...
Lorsque la fonction est dérivable, il faut toujours faire le tableau de signes complet de la dérivée pour pouvoir bien comprendre la situation.
\end{remarque}
...
\begin{exemple}
	\tcblower
Déterminer les asymptotes horizontales de la fonction $f$ définie par $f(x) = \dfrac{x^2 - x}{x^2 + 3x - 4}$

Comme $n = m = 1$, on sait déjà que $y = 1$ est une asymptote horizontale de $f$ à $\pm\infty$ ; confirmons par un calcul :

$\displaystyle\lim_{x \to +\infty} f(x) = \lim_{x \to +\infty} \dfrac{x^2 - x}{x^2 + 3x - 4} = \lim_{x \to +\infty} \dfrac{x^2\left(1 - \dfrac{1}{x}\right)}{x^2\left(1 + \dfrac{3}{x} - \dfrac{4}{x^2}\right)} = \lim_{x \to +\infty} \dfrac{1 - \dfrac{1}{x}}{1 + \dfrac{3}{x} - \dfrac{4}{x^2}} = \dfrac{1 - 0}{1 + 0 - 0} = \dfrac{1}{1} = 1$

$y = 1$ est une asymptote horizontale de $f$ à $\pm\infty$

remarque : comme on pouvait aussi aussi écrire $f(x) = \dfrac{x}{x + 4}$ (voir l'exemple précédent), on aurait pu faire le calcul suivant :
...
\end{exemple}
%\section{Exercices}
%\insertexo{1M-j2esz}{false}{exo}{true}
%\insertexo{1M-rqd6n}{false}{exo}{true}
%\insertexo{1M-mmztw}{false}{exo}{true}
%\insertexo{1M-uhfwb}{false}{exo}{true}
%\insertexo{1M-sjs2h}{false}{exo}{true}
%\insertexo{1M-hb4kv}{false}{exo}{true}
%\insertexo{1M-g75hx}{false}{exo}{true}
%\insertexo{1M-ayg94}{false}{exo}{true}
%\insertexo{1M-pbjwq}{false}{exo}{true}
%\insertexo{1M-5tfx9}{false}{exo}{true}
%\insertexo{1M-ddnv1}{false}{exo}{true}
%\insertexo{1M-nj1k9}{false}{exo}{true}
%\insertexo{1M-p9k57}{false}{exo}{true}
%\insertexo{1M-22t18}{false}{exo}{true}
%\insertexo{1M-h2mu9}{false}{exo}{true}
%\insertexo{1M-y1c7r}{false}{exo}{true}
%\insertexo{1M-c6eaz}{false}{exo}{true}
%\insertexo{1M-ezscr}{false}{exo}{true}
%\insertexo{1M-4pfpm}{false}{exo}{true}
%\insertexo{1M-bgaa8}{false}{exo}{true}
%
%\insertexo{1M-1h2rj}{false}{exo}{true}
%\insertexo{1M-bv651}{false}{exo}{true}
%\insertexo{1M-1h1tt}{false}{exo}{true}
%\insertexo{1M-t3pgp}{false}{exo}{true}
%\insertexo{1M-r98sf}{false}{exo}{true}
%\insertexo{1M-51tvf}{false}{exo}{true}
%\insertexo{1M-ju5sg}{false}{exo}{true}
%\insertexo{1M-ttwes}{false}{exo}{true}
%\insertexo{1M-yazhe}{false}{exo}{true}
%\insertexo{1M-rv1yv}{false}{exo}{true}
%\insertexo{1M-vnbfx}{false}{exo}{true}
%\insertexo{1M-ryapx}{false}{exo}{true}
%\insertexo{1M-zeeed}{false}{exo}{true}
%\insertexo{1M-gv9rr}{false}{exo}{true}
%\insertexo{1M-fcxr6}{false}{exo}{true}
%\insertexo{1M-8wcq9}{false}{exo}{true}
%\insertexo{1M-vrkth}{false}{exo}{true}
%\insertexo{1M-gmcwt}{false}{exo}{true}
%\insertexo{1M-shcv8}{false}{exo}{true}
%\insertexo{1M-9q8gz}{false}{exo}{true}
%\insertexo{1M-xkwd5}{false}{exo}{true}
%\insertexo{1M-bs74m}{false}{exo}{true}
%\insertexo{1M-nv48n}{false}{exo}{true}
%\insertexo{1M-pmwx1}{false}{exo}{true}
%\insertexo{1M-fnj4z}{false}{exo}{true}
%\insertexo{1M-bhu5u}{false}{exo}{true}
%\insertexo{1M-sms7s}{false}{exo}{true}
%\insertexo{1M-y4385}{false}{exo}{true}
%\insertexo{1M-2at6d}{false}{exo}{true}
%\insertexo{1M-mj5qq}{false}{exo}{true}
%\insertexo{1M-hgcu8}{false}{exo}{true}
%\insertexo{1M-y4dv7}{false}{exo}{true}
%\insertexo{1M-ek51g}{false}{exo}{true}
%\insertexo{1M-5en1r}{false}{exo}{true}
%\insertexo{1M-1gayt}{false}{exo}{true}
%\insertexo{1M-955md}{false}{exo}{true}
%\insertexo{1M-g4sjk}{false}{exo}{true}
%\insertexo{1M-b3p6g}{false}{exo}{true}
%\insertexo{1M-515q8}{false}{exo}{true}
%\insertexo{1M-yn5fe}{false}{exo}{true}
%\insertexo{1M-3exms}{false}{exo}{true}
%\insertexo{1M-w3pgx}{false}{exo}{true}
%\insertexo{1M-fg15r}{false}{exo}{true}
%\insertexo{1M-2mqwc}{false}{exo}{true}
%\insertexo{1M-m4mzh}{false}{exo}{true}
%\insertexo{1M-wu8y4}{false}{exo}{true}
%\insertexo{1M-u7dja}{false}{exo}{true}
%\insertexo{1M-e1wtj}{false}{exo}{true}
%\insertexo{1M-hvq58}{false}{exo}{true}
%\insertexo{1M-uvgs1}{false}{exo}{true}
%\insertexo{1M-7zb7h}{false}{exo}{true}
%\insertexo{1M-hzaw5}{false}{exo}{true}
%\insertexo{1M-uyvgj}{false}{exo}{true}
%\insertexo{1M-qsgvn}{false}{exo}{true}
%\insertexo{1M-kksbd}{false}{exo}{true}
%\insertexo{1M-c3ghj}{false}{exo}{true}
%\insertexo{1M-meks3}{false}{exo}{true}
