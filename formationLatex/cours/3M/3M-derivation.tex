...
\begin{thm}
Image d'un fermé par une fonction continue
\tcblower
Si $f : I \to \mathbb{R}$ est une fonction continue sur $[a,b]$, alors il existe $m$ et $M$ deux nombres réels tels que $f([a,b]) = [m,M]$
