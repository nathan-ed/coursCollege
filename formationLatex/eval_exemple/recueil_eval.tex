...
% Define your filters
\def\choixAnnee{2425}
\def\choixTheme{}%factorisation}%, eq1, eq2, completionCarre, equations, probEq2, probEq1}
\def\choixNiveau{1M}
\def\choixSource{}
\def\choixTypeExo{ER}
...
\renewcommand{\sujet}{{\Large Recueil d'exercices}}
\renewcommand{\etablissement}{doc}
...
for file in lfs.dir(src_dir) do
    if file:match("%.tex$") then
        ...
        if f then
            ...
            local typeExo = content:match("\\type%s*{(.-)}")
	    -- local all = "all"
