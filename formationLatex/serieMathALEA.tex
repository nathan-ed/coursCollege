...
\begin{enumerate}[]
	...
	\item La droite représentant la fonction affine $g$ passe par le point de coordonnées $(5;34)$ et coupe l'axe des ordonnées en $(0;9)$.\\Donner l'expression de  $g(x)$.\\\begin{tikzpicture}[baseline,scale = 0.6]
...
\end{tikzpicture}\\
	...
	\item La droite représentant la fonction affine $j$ passe par le point de coordonnées $(5;-45)$ et coupe l'axe des ordonnées en $(0;-5)$.\\Calculer l'antécédent de $-61$ par $j$.\\\begin{tikzpicture}[baseline,scale = 0.6]
...
\end{tikzpicture}\\
	...
	\item La droite représentant la fonction affine $m$ passe par le point de coordonnées $(7;-33)$ et coupe l'axe des ordonnées en $(0;-5)$.\\Calculer l'image de $10$ par $m$.\\\begin{tikzpicture}[baseline,scale = 0.6]
