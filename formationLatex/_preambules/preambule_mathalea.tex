...
\RequirePackage{pst-poly}      % For polygons in PSTricks
\RequirePackage{pst-text}      % For text effects in PSTricks
\RequirePackage{pst-tree}      % For trees in PSTricks
\RequirePackage{scratch3}      % For Scratch programming blocks
