...
\task Déterminer la fonction affine $g$ dont le graphe coupe l'axe $O x$ en $I=(-5 ; 0)$ et dont la pente vaut $-\frac{5}{8}$. En déduire l'ordonnée du point $J=(0 ; ?)$ appartenant au graphe de $g$.
