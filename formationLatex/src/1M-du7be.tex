...
\correction{
	\tcblower
\begin{tasks}
	\task Par exemple, si $f(x)=-\dfrac{1}{x^2}$ et $g(x)=\dfrac{1}{x^4}$ alors 
	$
	\begin{aligned}\lim_{x\to 0}-\dfrac{1}{x^2}+\dfrac{1}{x^4}&=\lim_{x\to 0} -\dfrac{x^2}{x^4}+\dfrac{1}{x^4}\\
		&=\lim_{x\to 0}\dfrac{-x^2+1}{x^4}\\
		&=\lim_{x\to 0} \dfrac{(1-x)(1+x)}{x^4}
		&=\dfrac{1}{\lim_{x\to 0} x^4}\\
		&=+\infty
	\end{aligned}$.
	\task Par le changement de variable $x=h+2$, on a bien l'égalité désirée.
