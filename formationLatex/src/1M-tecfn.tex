...
\begin{tasks}
  ...
  \stackrel{\text{P1}}{=} \dfrac{\lim_{x \to 1} (x^2 - 6x + 8)}{\lim_{x \to 1} (x^2 + 5x + 4)}
  \stackrel{\text{L2}}{=} \dfrac{1^2 - 6\cdot1 + 8}{1^2 + 5\cdot1 + 4}
  = \dfrac{3}{10} \)

  \task \( \displaystyle \lim_{x \to 0} \dfrac{\sqrt{x^2 - 4x + 16}}{3}
  \stackrel{\text{P0}}{=} \dfrac{1}{3} \cdot \lim_{x \to 0} \sqrt{x^2 - 4x + 16}
  \stackrel{\text{thm 7 + L4}}{=} \dfrac{1}{3} \cdot \sqrt{0^2 - 4\cdot0 + 16}
  = \dfrac{1}{3} \cdot 4 = \dfrac{4}{3} \)

  \task \( \displaystyle \lim_{x \to -\frac{\pi}{2}} \cos(2x)
  \stackrel{\text{thm 7}}{=} \cos\left(\lim_{x \to -\frac{\pi}{2}} 2x\right)
