...
\stackrel{\text{P1, L2}}{=} \dfrac{(-1)^3 - 5(-1) + 1}{1}
= \dfrac{-1 + 5 + 1}{1} = \dfrac{5}{1} = 5 \)

\task \( \displaystyle \lim_{x \to 1} \dfrac{x^2 - 2}{x^2 + 3x + 5}
\stackrel{\text{P4}}{=} \dfrac{\lim_{x \to 1} (x^2 - 2)}{\lim_{x \to 1} (x^2 + 3x + 5)}
\stackrel{\text{L2}}{=} \dfrac{1 - 2}{1 + 3 + 5} = \dfrac{-1}{9} = -\dfrac{1}{9} \)
  \task \( \displaystyle \lim_{x \to 2} \dfrac{2}{2x + 4}
  \stackrel{\text{P4}}{=} \dfrac{2}{\lim_{x \to 2} (2x + 4)}
  \stackrel{\text{P1, L2}}{=} \dfrac{2}{2\cdot2 + 4}
  = \dfrac{2}{8} = \dfrac{1}{4} \)
  \task \( \displaystyle \lim_{x \to 1} \dfrac{2 - x}{x^2 - 16}
  = \dfrac{2 - 1}{1^2 - 16}
  = \dfrac{1}{-15} = -\dfrac{1}{15} \quad \text{(par L2)} \)

 \task \( \displaystyle \lim_{x \to 3} \dfrac{5x}{(x + 3)^2}
  = \dfrac{15}{36} = \dfrac{5}{12} \quad \text{(par L2)} \)

\task \( \displaystyle \lim_{x \to 1} \dfrac{x^2 - 1}{x^2 + 3x + 5}
\stackrel{\text{P4}}{=} \dfrac{1 - 1}{1 + 3 + 5}
= \dfrac{0}{9} = 0 \)
\task \( \displaystyle \lim_{x \to 2} \dfrac{x^2 + 4x + 4}{x^2 - x - 6}
=\lim_{x\to 2} \dfrac{(x + 2)^2}{(x - 3)(x + 2)} \stackrel{x\neq -2}{=}\lim_{x\to 2}\dfrac{x + 2}{x - 3} = \lim_{x\to 2} \dfrac{4}{-1} = -4 \)
\task 
\(
\begin{aligned}
\lim_{x \to 0} \sqrt{x^2 - 2x + 4 + 2x}
&= \lim_{x \to 0} \sqrt{x^2 + 2x + 4} = \sqrt{4} = 2
\end{aligned}
\)
...
&= \lim_{x \to 2} \sqrt{x^2 - x + 4} = \sqrt{6}
\end{aligned}
\)
\task   
\(
