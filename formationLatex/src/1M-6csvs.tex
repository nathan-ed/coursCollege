...
\correction{
\tcblower
On écrit $P(x)=ax^3+bx^2+cx+d$ avec $a,b,c,d\in \mathbb{R}$ et $a\neq 0$. On a que pour un nombre $n$ assez petit, $\text{signe}(P(n))=-\text{signe}(a)$ et que pour un nombre $m$ assez grand, $\text{signe}(P(m))=\text{signe}(a)$. La fonction $x\mapsto P(x)$ est continue sur tout $\mathbb{R}$, donc aussi sur $[n;m]$. Ainsi, par la corollaire du théorème de la valeur intermédiaire, il existe $r\in\[n;m]$ tel que $P(r)=0$. 
}
