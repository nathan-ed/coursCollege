...
\tcblower
\begin{tasks}
	\task On a que $-|f(x)|\leq f(x)\leq |f(x)|$, donc par le théorème des deux gendarmes, $\lim_{x\to a}f(x)=0$. 
	...
	\task On a bien $\lim_{x\to 0}f(x)=f(0)$, donc la fonction est continue en $0$ 
\end{tasks}
}
