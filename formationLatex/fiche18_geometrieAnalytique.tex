...
auteur={ns},theme={Fonctions -- Géométrie analytique (introduction)}]{packages/bandeaux}
...
\medskip
   \begin{exo}
       \begin{tasks}
        ...
        \task Déterminer la longueur hauteur du triangle $ABC$ issue de $A$ où $A(0;1)$, $B(-2;3)$ et $C(-8;7)$.
        \task Choisir trois points non colinéaire dans le plan, calculer l'aire du triangle définit par ces points. 
       \end{tasks}
   \end{exo}
\end{document}
