...
\node[below=0.9cm,xshift=3cm] { identifier les carrés }; 
\node(11)[bag,below=0.5cm, xshift=6cm] {\emptybox};
child{
	\node(2a)[below=2.5cm] {$a$};
	child{
		\node(2)[bag,below=3cm] {\emptybox};
		\node[below=3.4cm,xshift=3cm] { déterminer $a$ et $b$ }; 
...
\node[xshift=3cm,above=1.2cm] {{\bfseries Identité 3}};
\node[xshift=3cm,above=0.7cm] {\bm{$a^2-b^2$}};
\node[xshift=3cm,above=0.2cm] {si différence de deux carrés};
\node[bag] {$a^2$};
	child{
\node(1)[bag,below=0.5cm] {\emptybox};
\node[below=0.9cm,xshift=3cm] { identifier les carrés }; 
...
\node[bag] {$a^2$};
	child{
		\node(1)[bag,below=0.5cm] {\boxt{$25x^2y^2$}};
\node[below=0.9cm,xshift=3cm] {identifier les carrés }; 
\node(11)[bag,below=0.5cm, xshift=6cm] {\boxt{$49z^2$}};
child{
	\node(2a)[below=2.5cm] {$a$};
	child{
		\node(2)[bag,below=3cm] {\boxt{$5xy$}};
		\node[below=3.4cm,xshift=3cm] {déterminer $a$ et $b$}; 
...
child{
	\node[below=4cm,xshift=3cm]{$\bm{(5xy-7z)(5xy+7z)}$};
}
}
\node[bag,xshift=6cm] {$b^2$};
\draw[->] (1)--(2a);
...
\begin{minipage}[t]{0.5\textwidth}{
\vspace{0pt}
\begin{tikzpicture}[scale=0.6,grow=right, sloped,
    ebox/.style={below=1mm, minimum width=10mm, minimum height=6mm, draw}
]
...
child{
	...
	child{
		...
		\node(3)[below=3.8cm,xshift=3cm] {est divisible par $cx$}; 
		\node(41)[below=5cm] {\checkmark on continue};
	\node(42)[below=5cm, xshift=4.7cm] {\XSolidBrush l'identité};
\node[below=5.5cm,xshift=4.7cm] {\enquote{somme-produit}};
		\node(51)[below=6.5cm]{le terme divisible est};
		...
		\node(61)[below=9.7cm]{\emptybox};
		\node(52)[below=6.5cm, xshift=4.5cm]{le terme non divisible est};
		\node[below=6.9cm, xshift=4.5cm]{{\bfseries un candidat pour}};
		\node[below=7.4cm,xshift=4.5cm]{le terme \enquote{produit}};
		\node(62)[below=7.9cm,xshift=4.5cm]{\emptybox};
		\node(7)[below=11cm,xshift=2.5cm]{reconstituer les};
		\node(8)[below=11.4cm,xshift=2.5cm]{termes $a$ et $b$ {\bfseries (somme-produit)}};
		\node(92)[below=12.2cm,xshift=4.5cm]{ $b$};
		\node(101)[below=12.7cm,xshift=4.5cm]{\emptybox};
		\node(91)[below=12.2cm]{ $a$};
		\node(102)[below=12.7cm]{\emptybox};
		\node(11)[below=13.7cm,xshift=2.5cm]{vérifier};
		\node(121)[below=14.5cm]{$(a+b)cx$};
		\node[below=15cm]{\emptybox};
		\node(122)[below=14.5cm,xshift=4.5cm]{$ab$};
...
\node[xshift=3cm,above=1cm] {};
\node[xshift=3cm,above=0.7cm] {};
\node[xshift=3cm,above=0.2cm] {\bm{$9x^2y^2+30xy+24$}};
\node[bag] {$c^2 x^2$};
	child{
		\node(1)[bag,below=0.5cm] {\fbox{$9x^2y^2$}};
\node(1t)[below=0.9cm,xshift=3cm] {identifier le carré}; 
\node(2t)[below=1.3cm,xshift=3cm] {et déterminer $cx$}; 
child{
	\node(2a)[below=2.5cm] {$cx$};
	child{
		\node(2)[bag,below=3cm] {\boxt{$3xy$}};
		\node[below=3.4cm,xshift=3cm] {vérifier si un autre terme}; 
		\node(3)[below=3.8cm,xshift=3cm] {est divisible par $cx$}; 
...
\node[below=5.5cm,xshift=4.7cm] {\enquote{somme-produit}};
		\node[below=6.9cm]{{}};
		\node[below=7.4cm]{};
		\node(51)[below=7.9cm]{\boxt{$30xy$}};
		\node[below=9.2cm]{le terme divisé};
		\node(61)[below=9.7cm]{\boxt{$10$}};
		\node(52)[below=6.5cm, xshift=4.5cm]{};
		\node[below=6.9cm, xshift=4.5cm]{};
		\node[below=7.4cm,xshift=4.5cm]{};
		\node(62)[below=7.9cm,xshift=4.5cm]{\boxt{$24$}};
		\node(7)[below=11cm,xshift=2.5cm]{reconstituer les};
		\node(8)[below=11.4cm,xshift=2.5cm]{termes $a$ et $b$ {\bfseries (somme-produit)}};
		\node(92)[below=12.2cm,xshift=4.5cm]{ $b$};
		\node(101)[below=12.7cm,xshift=4.5cm]{\boxt{$6$}};
		\node(91)[below=12.2cm]{ $a$};
		\node(102)[below=12.7cm]{\boxt{$4$}};
		\node(11)[below=13.7cm,xshift=2.5cm]{vérifier};
		\node(121)[below=14.5cm]{$(4+6)3xy$};
		\node[below=15cm]{\boxt{$30xy$}\checkmark};
		\node(122)[below=14.5cm,xshift=4.5cm]{$4\cdot 6$};
		\node[below=15cm,xshift=4.5cm]{\boxt{$10$}\checkmark};
	\node[below=16.1cm,xshift=2.3cm]{$\bm{(3xy+4)(3xy+6)}$};
	}
}
}
